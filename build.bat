...
D:\MinGW\bin\mingw32-g++.exe -c src/Background.cpp src/Bullet.cpp src/Ennemy.cpp src/gameInputs.cpp src/main.cpp src/Player.cpp src/Score.cpp src/WindowGestion.cpp src/Menus.cpp src/Animation.cpp -ID:\Documents\Prog\SFML\SFML-2.4.2\include -ID:\Documents\Prog\SFML-SpaceShooter

echo Finishing ...
D:\MinGW\bin\mingw32-g++.exe -LD:\Documents\Prog\SFML\SFML-2.4.2\lib -o SpaceShooter.exe main.o Background.o Bullet.o Ennemy.o gameInputs.o Player.o Score.o WindowGestion.o Menus.o Animation.o -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -static-libstdc++ -static-libgcc
